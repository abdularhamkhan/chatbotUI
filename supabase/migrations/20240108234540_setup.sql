...
AS $$
DECLARE
  project_url TEXT := 'https://oilghapbnjxuzipyikhx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9pbGdoYXBibmp4dXppcHlpa2h4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMDgyODYzOSwiZXhwIjoyMDQ2NDA0NjM5fQ.b3ETtExLuhMNKVwb2XWc2GVQyIrQS_kOihW-foEm1YY'; -- full access needed for http request to storage
